...
export const Card = function (noteData) {
  ...
  /**
   * Note details view & edit functionality
   *
   ...
   * if the deletion is confrimed, it updates the UI and database to remove the note.
   */

  const /** {HTMLElement} */ deleteBtn =
      card.querySelector("[date-delete-btn]");
  deleteBtn.addEventListener("click", function (evenet) {
